// Plné dáta o všetkých dielach. Tento modul staticky importuje všetky ročníky,
// takže je veľký — v aplikácii ho NEIMPORTUJ priamo. Používa ho generátor
// odľahčeného indexu (scripts/) a lazy loader v data/index.ts.
