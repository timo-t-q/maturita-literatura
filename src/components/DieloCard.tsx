...
import { menoAutora, nazovDruhu } from '../data'
import { Badge } from './Badge'
import { StavButton } from './StavButton'
import { useProgress } from '../lib/progress'

export function DieloCard({ dielo }: { dielo: Dielo }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        ...
        <p className="mt-1 text-sm text-stone-500 dark:text-stone-400">{menoAutora(dielo)}</p>
